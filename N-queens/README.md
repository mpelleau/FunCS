...
The [N-queens Problem](https://en.wikipedia.org/wiki/Eight_queens_puzzle) is a wellknown puzzle in combinatorics. The goal is to put ![https://latex.codecogs.com/gif.latex?n](https://www.codecogs.com/eqnedit.php?latex=n) non-attacking queens on a ![https://latex.codecogs.com/gif.latex?n\times&space;n](https://www.codecogs.com/eqnedit.php?latex=n\times&space;n) checkerboard. A queen can attack another is they are on the same row, same column or the same diagonals.
